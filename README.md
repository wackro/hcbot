hcbot
=============
A Slack bot written in python that connects via the RTM API. Forked from [python-rtmbot](https://github.com/slackhq/python-rtmbot).
...
1. Download the code
        ...
        git clone git@github.com:wackro/hcbot.git
        cd python-rtmbot
...
3. Configure hcbot (https://api.slack.com/bot-users)
